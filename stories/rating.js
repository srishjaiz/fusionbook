...
ratingStory.addChapter(
    'onUpdate and on Draw called with valid function ref',
    story => {
        var a= new rating(story,config);
        a.onUpdate=function f(){
...
ratingStory.addChapter(
    'onUpdate and on Draw are not called and error thrown with any other ref than function ref',
    story => {
        var a= new rating(story,config);
        a.onUpdate=0;
        a.onDraw={};
...
ratingStory.addChapter(
    'onUpdate and on Draw are not called when nothing is given',
    story => {
        var a= new rating(story,config);
        var bound= a.update.bind(a);
        setTimeout(()=>{
