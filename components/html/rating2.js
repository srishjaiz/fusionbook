...
function create(){
    var el=this.el;
    var args=this.args;
    var svg_height=args.svg_height;
    var svg_width=args.svg_width;
    var fill_rated=args.fill_rated;
    var fill_unrated=args.fill_unrated;
    var star_strokewidth=args.star_strokewidth;
    var N=args.N;
    var stroke_rated=args.stroke_rated;
    var stroke_unrated=args.stroke_unrated;
    var orientation=args.orientation;
    var rating_value=args.rating_value;
    var padding=args.padding;
    var justify=args.justify;
